...
<div class="container-fluid login-section">
    <div class="row">
        ...
        <div class="col-md-6 d-none d-lg-flex left-panel">
            ...
            <img src="images/POLICE.png" width="550" height="350" style="border-radius: 20px;margin-left: 100px;box-shadow: 4px 4px 8px 0 rgba(0, 0, 0, 0.5); " alt="User Icon">
        </div>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card login-card p-4">
                    ...
                    <div class="text-center">
                        <img src="images/POLICE.png"  class="logo" alt="Logo">
