...
<%
    ...
    String sql = "Select count(complaint_id) from vehicle_complaints";
    ...
    String sql1 = "Select count(complaint_id) from vehicle_complaints where status='Open'";
    ...
    String sql2 = "Select count(complaint_id) from vehicle_complaints where status='Closed'";
...
<h4 class="mb-4">Police Admin Dashboard</h4>
