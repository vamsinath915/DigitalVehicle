...
<div class="container-fluid login-page mt-5 pt-4" style="background:url('images/bg4.jpg');background-size: cover; ">
    <div class="row min-vh-100">

        <!-- LEFT SIDE (Optional image/info) -->
        <div class="col-lg-7 d-none d-lg-flex left-panel">
            
            <img src="images/insurance_1.jpg" width="550" height="350" style="border-radius: 20px" alt="User Icon">
        </div>
        ...
        <div class="col-lg-5 col-md-8 col-sm-10 m-auto mr-auto">
            <div class="login-box">
                ...
                <div class="user-icon">
                    <img src="images/insurance.png" alt="User Icon">
                </div>

                <h3 class="text-center mb-4">Insurance Sign In</h3>
