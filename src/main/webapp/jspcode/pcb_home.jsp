...
/*String user = "Admin";
    ...
    if(username == null) {
        response.sendRedirect("pcb_login.jsp"); // Redirect to login if session expired
        return;
    }*/
...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
    <div class="container-fluid">
        <span class="navbar-brand fw-bold text-primary">PCB Admin Panel</span>
        ...
        <div class="dropdown ms-auto">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item text-danger" href="pcb_logout.jsp">Logout</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="col-md-2 sidebar">
    ...
    <a href="pcb_dashboard.jsp" target="contentFrame" class="menu-item active">
    ...
    <div class="submenu" id="pollutionSub">
        <a href="viewPCRequests.jsp" target="contentFrame"><i class="fa fa-list-check small-icon me-2"></i> PC Requests</a>
        <a href="approvedPCDetails.jsp" target="contentFrame"><i class="fa fa-check small-icon me-2"></i>PC Details</a>
    </div>
...
<!--<div class="submenu" id="feedbackSub" >
    ...
    <a href="pcb_logout.jsp" class="menu-item">
...
<div class="col-md-10 p-0">
    <iframe name="contentFrame" src="pcb_dashboard.jsp" class="content-frame"></iframe>
</div>
