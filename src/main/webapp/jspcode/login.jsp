...
.login-card {
    ...
    border-radius: 50%;
    background: linear-gradient(135deg, #0f2027, #203a43, #F72800);//linear-gradient(135deg, #1e3c72, #2a5298);
...
/*}
.login-card {
    background: linear-gradient(135deg, #0f2027, #203a43, #F72800);//rgba(255, 255, 255, 0.15);
...
<!--                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <section class="home-section mt-5 pt-4">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="login-card">
                    <img src="images/rto.png" alt="RTO">
                    <h5>RTO</h5>
                    <a href="rto-login.jsp" class="btn btn-primary">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="login-card">
                    <img src="images/owner.png" alt="Vehicle Owner">
                    <h5>Vehicle Owner</h5>
                    <a href="owner-login.jsp" class="btn btn-primary">
                        Login <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="login-card">
                    ...
                    <h5>Pollution Control Board</h5>
                    <a href="pcb-login.jsp" class="btn btn-primary">
                        Login <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="login-card">
                    ...
                    <h5>Insurance</h5>
                    <a href="insurance-login.jsp" class="btn btn-primary">
                        Login <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="login-card">
                    ...
                    <h5>Traffic Department</h5>
                    <a href="traffic-login.jsp" class="btn btn-primary">
                        Login <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="login-card">
                    ...
                    <a href="police-login.jsp" class="btn btn-primary">
                        Login <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
      ...
      <div class="col-lg-8 col-md-10">
        ...
        <div class="gradient-border-box">
          <div class="content-box text-center">
            ...
            <div class="mt-4">
              <a href="login.jsp" class="btn btn-dark btn-lg px-4 me-2">
