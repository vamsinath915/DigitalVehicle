...
ps=con.prepareStatement("SELECT vc.* FROM vehicle_complaints vc JOIN vehicles v "
        + "ON vc.vehicle_number = v.vehicle_number WHERE v.owner_id=? ORDER BY vc.complaint_date DESC;");
