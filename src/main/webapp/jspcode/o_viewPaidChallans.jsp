...
ps=con.prepareStatement("SELECT tc.* FROM traffic_challans tc JOIN vehicles v "
        + "ON tc.vehicle_number = v.vehicle_number WHERE tc.status='Paid' "
        + "AND v.owner_id=? ORDER BY tc.challan_date DESC;");
