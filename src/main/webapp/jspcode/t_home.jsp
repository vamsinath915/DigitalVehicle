...
<%
    ...
    if(username == null) {
        response.sendRedirect("t_login.jsp"); // Redirect to login if session expired
        return;
    }*/
%>
<!DOCTYPE html>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
    <div class="container-fluid">
        <span class="navbar-brand fw-bold text-primary">Traffic Admin Panel</span>
        ...
        <div class="dropdown ms-auto">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item text-danger" href="t_logout.jsp">Logout</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="col-md-2 sidebar">
    ...
    <a href="t_dashboard.jsp" target="contentFrame" class="menu-item active">
        <i class="fa fa-chart-pie"></i> Dashboard
    </a>

    <a data-bs-toggle="collapse" href="#pollutionMenu"  class="menu-item" onclick="toggleMenu(this,'pollutionSub')">
        <i class="fa fa-leaf"></i> Challan Info
        <i class="fa fa-chevron-down ms-auto"></i>
    </a>
    <div class="submenu" id="pollutionSub">
        <a href="AddTrafficChallan.jsp" target="contentFrame"><i class="fa fa-plus-circle small-icon me-2"></i> Add Challan</a>
        <a href="ViewChallanDetails.jsp" target="contentFrame"><i class="fa fa-list-check small-icon me-2"></i>View Challan</a>
        <a href="viewPaidChallans.jsp" target="contentFrame"><i class="fa fa-check small-icon me-2"></i>Paid Challans</a>
        <a href="ViewPendingChallans.jsp" target="contentFrame"><i class="fa fa-clock small-icon me-2"></i>Pending Challans</a>
    </div>
...
<!--<div class="submenu" id="feedbackSub" >
    ...
    <a href="t_logout.jsp" class="menu-item">
...
<div class="col-md-10 p-0">
    <iframe name="contentFrame" src="t_dashboard.jsp" class="content-frame"></iframe>
</div>
